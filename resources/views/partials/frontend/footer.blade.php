        ...
        <div class="luxury-footer-main">
            ...
            <a href="{{ url('/') }}" class="luxury-footer-logo">
                <img
                        ...
                        alt="{{ config('app.name', 'Online Shop') }}"
                >
            </a>
            ...
            <nav class="luxury-footer-links">
                ...
                <a href="{{ route('shop.index') }}">
                    {{ __('general.footer.shop') }}
                </a>

                <a href="{{ route('cart.index') }}">
                    {{ __('general.footer.cart') }}
                </a>

                <a href="{{ route('user.dashboard') }}">
                    {{ __('general.footer.account') }}
                </a>

                <a href="{{ route('contact.index') }}">
                    {{ __('general.footer.contact') }}
                </a>

                <a href="{{ route('page.show', 'privacy-policy') }}">
                    {{ __('general.footer.privacy') }}
                </a>
            ...
            <div class="luxury-footer-social">
                ...
                <a
                        href="https://www.instagram.com/alhbbash"
                        target="_blank"
                ...
                <a
                        href="mailto:alila3883@gmail.com"
                        aria-label="Email"
                >
                    <svg viewBox="0 0 24 24">
